...
const outboxDispatcher = outboxBroadcastEnabled
  ? createDefaultOutboxDispatcher()
  : null;
...
const searchIndexerWorker = new SearchIndexerWorker(
  new WorkerSearchContentSource(),
);
