  ...
  const items: CommandItem[] = useMemo(() => {
    const list: CommandItem[] = [
      ...
      // Settings (5 Core Pillars)
      {
        ...
        description:
          "Publication info, locale, language, and publishing defaults",
      ...
      },
      {
        ...
        description:
          "Stripe payments, subscription tiers, and member access rules",
        category: "Settings" as const,
      ...
      },
      {
        ...
        description:
          "Email newsletters, predictive intelligence, and community",
        category: "Settings" as const,
      ...
      },
      {
        ...
        description:
          "API keys, webhooks, plugins SDK, system diagnostics, and audit logs",
        category: "Settings" as const,
      ...
      >
        ...
        <div className="overflow-y-auto p-2 space-y-1 flex-1">
          {filteredItems.length === 0 ? (
            <div className="p-8 text-center text-xs text-muted-foreground">
              No matching commands found for{" "}
        ...
        <div className="flex items-center justify-between px-4 py-2 border-t border-border/60 bg-muted/10 text-[11px] text-muted-foreground">
          <div className="flex items-center gap-2">
            ...
            <kbd className="bg-muted px-1 rounded border border-border">↓</kbd>
            <span>Select:</span>
            <kbd className="bg-muted px-1.5 rounded border border-border">
              ↵
            </kbd>
          </div>
