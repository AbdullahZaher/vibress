...
import { AdminRedirect, createRedirectApi, deleteRedirectApi } from '../../lib/api';
...
export function RedirectsPanel({ redirects, onError, onMessage, onChanged }: RedirectsPanelProps) {
