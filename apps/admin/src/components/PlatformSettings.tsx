  ...
  return (
    <div className="space-y-8 w-full max-w-7xl mx-auto">
      ...
      <div className={tab === 'integrations' ? '' : 'hidden'}>
        <IntegrationsPanel integrations={integrations} onError={setError} onMessage={setMessage} onChanged={refresh} />
      </div>
      ...
      <div className={tab === 'webhooks' ? '' : 'hidden'}>
        <WebhooksPanel webhooks={webhooks} onError={setError} onMessage={setMessage} onChanged={refresh} />
      </div>
      <div className={tab === 'plugins' ? '' : 'hidden'}>
        <PluginsPanel plugins={plugins} onError={setError} onChanged={refresh} />
      </div>
    </div>
  );
}