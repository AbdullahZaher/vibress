...
import { AdminProduct, createProductApi, archiveProductApi } from '../../lib/api';
...
export function ProductTiersPanel({ products, onError, onMessage, onChanged }: ProductTiersPanelProps) {
