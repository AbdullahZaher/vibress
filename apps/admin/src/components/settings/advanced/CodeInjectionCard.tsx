...
interface CodeInjectionCardProps {
  ...
  onChange?: ((key: 'headerCode' | 'footerCode', value: string) => void) | undefined;
          ...
          <div className="w-full max-w-2xl bg-card border-l border-border/80 shadow-2xl h-full flex flex-col justify-between animate-in slide-in-from-right duration-200">
            ...
            <div className="flex items-center justify-between p-5 border-b border-border/60 bg-muted/20">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-foreground">Code Injection Editor</h3>
              </div>
              <button
                type="button"
            ...
            <div className="p-6 overflow-y-auto space-y-5 flex-1">
              <div className="space-y-1.5">
                <label htmlFor="card-code-head" className="text-xs font-semibold text-foreground flex items-center gap-1.5">
              ...
              <div className="space-y-1.5 pt-2">
                <label htmlFor="card-code-foot" className="text-xs font-semibold text-foreground flex items-center gap-1.5">
                  <Terminal className="h-3.5 w-3.5 text-muted-foreground" />
