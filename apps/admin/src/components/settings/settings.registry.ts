...
export type PillarId = 'general' | 'site' | 'membership' | 'growth' | 'advanced';
    ...
    cards: [
      {
        ...
        keywords: ['title', 'description', 'name', 'tagline', 'brand', 'site name'],
        pillarId: 'general',
        anchor: 'general-info',
        editorMode: 'inline',
        requiredPermission: 'settings.general.manage',
      ...
      },
      {
        ...
        keywords: ['language', 'locale', 'timezone', 'time', 'date', 'utc', 'arabic', 'english'],
        pillarId: 'general',
      ...
      },
      {
        ...
        description: 'Preview how your publication appears in Google search, X / Twitter, and Facebook.',
        keywords: ['seo', 'meta', 'social', 'google', 'twitter', 'facebook', 'opengraph', 'search engine', 'preview'],
        pillarId: 'general',
      ...
      },
      {
        ...
        keywords: ['private', 'password', 'protect', 'lock', 'staging', 'access'],
        pillarId: 'general',
      ...
      },
      {
        ...
        keywords: ['staff', 'users', 'team', 'authors', 'editors', 'permissions', 'roles', 'invite'],
        pillarId: 'general',
    ...
    cards: [
      {
        ...
        keywords: ['design', 'branding', 'color', 'accent', 'icon', 'logo', 'cover', 'favicon', 'theme style'],
        pillarId: 'site',
      ...
      },
      {
        ...
        keywords: ['navigation', 'nav', 'menu', 'links', 'header', 'footer', 'primary nav', 'secondary nav'],
        pillarId: 'site',
      ...
      },
      {
        ...
        keywords: ['themes', 'templates', 'molten', 'default', 'upload theme', 'preview', 'switch theme'],
        pillarId: 'site',
        anchor: 'site-themes',
        editorMode: 'drawer',
        requiredPermission: 'settings.site.manage',
      ...
      },
      {
        ...
        keywords: ['announcement', 'banner', 'top bar', 'alert', 'notice', 'promotion'],
        pillarId: 'site',
    ...
    cards: [
      {
        ...
        description: 'Configure how readers sign up, access member-only content, and manage session durations.',
        keywords: ['members', 'signup', 'portal', 'register', 'session', 'ttl', 'access', 'login'],
        pillarId: 'membership',
      ...
      },
      {
        ...
        keywords: ['tiers', 'plans', 'billing', 'stripe', 'paid', 'subscriptions', 'pricing', 'currency', 'money'],
        pillarId: 'membership',
      ...
      },
      {
        ...
        keywords: ['offers', 'discounts', 'coupons', 'promotions', 'sales', 'trials'],
        pillarId: 'membership',
    ...
    cards: [
      {
        ...
        keywords: ['newsletter', 'email', 'smtp', 'mail', 'sender', 'mailpit', 'delivery', 'test email'],
        pillarId: 'growth',
      ...
      },
      {
        ...
        keywords: ['analytics', 'tracking', 'google', 'ga', 'ga4', 'plausible', 'posthog', 'stats', 'visitors'],
        pillarId: 'growth',
      ...
      },
      {
        ...
        keywords: ['comments', 'discussions', 'community', 'moderation', 'spam', 'replies'],
        pillarId: 'growth',
      ...
      },
      {
        ...
        keywords: ['recommendations', 'blogroll', 'cross-promotion', 'partners', 'network'],
        pillarId: 'growth',
    ...
    cards: [
      {
        ...
        keywords: ['code', 'injection', 'custom css', 'javascript', 'header code', 'footer code', 'script'],
        pillarId: 'advanced',
      ...
      },
      {
        ...
        description: 'Manage API keys, outgoing webhooks, and third-party plugin extensions.',
        keywords: ['api', 'keys', 'webhooks', 'plugins', 'developer', 'integrations', 'zapier', 'tokens'],
        pillarId: 'advanced',
      ...
      },
      {
        ...
        keywords: ['diagnostics', 'health', 'cache', 'redis', 'database', 'purge', 'memory', 'status'],
        pillarId: 'advanced',
      ...
      },
      {
        ...
        keywords: ['import', 'export', 'backup', 'migrate', 'ghost', 'wordpress', 'substack', 'json'],
        pillarId: 'advanced',
      ...
      },
      {
        ...
        keywords: ['audit', 'logs', 'security', 'history', 'activity', 'events', 'compliance'],
        pillarId: 'advanced',
      ...
      },
      {
        id: 'danger-zone',
        title: 'Danger zone',
        description: 'Irreversible destructive actions such as deleting all content or resetting configurations.',
        keywords: ['danger', 'delete', 'reset', 'destroy', 'wipe', 'all content'],
        pillarId: 'advanced',
