      ...
      <SettingsCardRow
        ...
        currentValue={
          <div className="flex items-center gap-2 font-medium text-xs">
            <span className="font-semibold text-foreground">{title || 'Vibress'}</span>
            {tagline && (
      ...
      {isExpanded && (
        <div className="border-t border-border/40 p-5 bg-muted/15 space-y-4 animate-in slide-in-from-top-2 duration-150">
          <div className="space-y-1.5">
            <label htmlFor="card-site-title" className="text-xs font-semibold text-foreground">
              Site title
            </label>
            <Input
              id="card-site-title"
              ...
              required
            />
            <p className="text-[11px] text-muted-foreground">The name of your publication or brand.</p>
          </div>

          <div className="space-y-1.5">
            <label htmlFor="card-site-tagline" className="text-xs font-semibold text-foreground">
              Site tagline
            </label>
            <Input
              ...
              className="bg-card text-xs h-9"
            />
            <p className="text-[11px] text-muted-foreground">A memorable short description of your site.</p>
          </div>

          <div className="space-y-1.5">
            <label htmlFor="card-site-desc" className="text-xs font-semibold text-foreground">
              Site description
            </label>
            <textarea
              id="card-site-desc"
            ...
            />
            <p className="text-[11px] text-muted-foreground">Used in themes and search engine metadata descriptions.</p>
          </div>
        </div>
      )}
    </SettingsCard>
