        ...
        <div className="border-t border-border/50 p-5 bg-muted/10 space-y-4 animate-in slide-in-from-top-2 duration-150">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <label htmlFor="card-site-lang" className="text-xs font-semibold text-foreground">
              ...
              <div className="flex gap-2">
                ...
                />
                <select
                  value={COMMON_LANGUAGES.some((l) => l.code === locale) ? locale : 'custom'}
                  onChange={(e) => {
              ...
              <p className="text-[11px] text-muted-foreground">Default IETF language tag for HTML and RSS feeds.</p>
            </div>

            <div className="space-y-1.5">
              <label htmlFor="card-site-tz" className="text-xs font-semibold text-foreground flex items-center gap-1.5">
              ...
              <p className="text-[11px] text-muted-foreground">Used for post scheduling and date formatting.</p>
            </div>
          </div>
        </div>
      )}
