  ...
  const accentColor =
    typeof extendedSite.accentColor === 'string' && extendedSite.accentColor
      ...
      : typeof settings.accentColor === 'string'
        ...
        : '#6366f1';
  const siteIcon = (extendedSite.iconUrl || extendedSite.icon) as string | undefined;
  const siteLogo = extendedSite.logoUrl as string | undefined;
  const primaryNav = extendedSite.primaryNav as Array<{ label: string; url: string }> | undefined;
  const secondaryNav = extendedSite.secondaryNav as Array<{ label: string; url: string }> | undefined;
        ...
        <footer className="site-footer-bottom outer">
          <div className="site-footer-bottom-inner inner">
            ...
            {secondaryNav && secondaryNav.length > 0 ? (
              <div className="site-footer-nav" style={{ display: 'flex', gap: '16px' }}>
