function dropdown() {
  let o = window.matchMedia("(max-width: 767px)"),
    i = document.querySelector(".vb-head-menu"),
    r = i?.querySelector(".nav");
  if (r) {
    let e = document.querySelector(".vb-head-logo"),
      t = r.innerHTML;
    o.matches &&
      ...
      if (!o.matches) {
        ...
        if (e.length) {
          let t = document.createElement("button"),
            n =
              (t.setAttribute("class", "nav-more-toggle vb-icon-btn"),
          ...
          (n.setAttribute("class", "vb-dropdown"),
            10 <= e.length
              ? (document.body.classList.add("is-dropdown-mega"),
                (n.style.gridTemplateRows = `repeat(${Math.ceil(e.length / 2)}, 1fr)`))
...
function pagination(e, s, l = !1) {
  let c = document.querySelector(".vb-feed");
  if (!c) return;
  let t = !1,
    n =
      c.nextElementSibling ||
      c.parentElement.nextElementSibling ||
      document.querySelector(".vb-foot"),
    u = document.querySelector(".vb-loadmore"),
    o =
          ...
          try {
            var e = await (await fetch(o.href)).text(),
              ...
              r = i.querySelectorAll(
                ".vb-feed:not(.vb-featured):not(.vb-related) > *",
              );
            ...
            a && a.href ? (o.href = a.href) : (o.remove(), u && u.remove());
          } catch (e) {
      ...
      if (((t = !0), e[0].isIntersecting))
        if (l) await o();
          ...
          for (
            ...
            await o();
      ((t = !1), document.querySelector("link[rel=next]") || i.disconnect());
    }
  });
...
(((e, t) => {
  ...
  ((e, t) => {
    ...
    return function (o, s) {
      function e(e) {
        if (T) return !0;
        ((e = e || window.event), C.timeToIdle && C.mouseUsed && !v && a());
        for (
          var t,
            n,
      ...
      function n() {
        ...
        e !== I && (M(d, "ui--one-slide", e), (I = e));
      }
      function t() {
        M(g, "share-modal--hidden", L);
      }
      function i() {
        ...
        ((g.children[0].innerHTML = i), (g.children[0].onclick = q));
      }
      function r(e) {
        for (var t = 0; t < C.closeElClasses.length; t++)
          if (s.hasClass(e, "pswp__" + C.closeElClasses[t])) return !0;
      }
      function a() {
        (clearTimeout(k), (F = 0), v && A.setIdle(!1));
      }
      function l(e) {
      ...
      function c(e) {
        b !== e && (M(x, "preloader--active", !e), (b = e));
      }
      function P(e) {
        var t,
          n = e.vGap;
          ...
          ? ((t = C.barsSize),
            C.captionEl && "auto" === t.bottom
              ? (p ||
                ...
                C.addCaptionHTMLFn(e, p, !0)
                  ? ((e = p.clientHeight), (n.bottom = parseInt(e, 10) || 44))
                  : (n.bottom = t.top))
        ...
        O = function () {
          return (
            (L = !L)
              ...
              : (t(),
                setTimeout(function () {
                  L || s.addClass(g, "pswp__share-modal--fade-in");
                }, 30)),
            L || i(),
            !1
          );
      ...
      ((A.init = function () {
        ...
        (s.extend(o.options, z, !0),
          ...
          w("doubleTap", function (e) {
            ...
            o.getZoomLevel() !== t
              ? o.zoomTo(t, e, 333)
              : o.zoomTo(C.getDoubleTapZoom(!1, o.currItem), e, 333);
          }),
          ...
          w("bindEvents", function () {
            (s.bind(d, "pswpTap click", e),
              ...
              o.likelyTouchDevice ||
                s.bind(o.scrollWrap, "mouseover", A.onMouseOver));
          }),
          w("unbindEvents", function () {
            (L || O(),
              ...
              u &&
                (s.unbind(document, u.eventK, A.updateFullscreen),
                u.isFullscreen() && ((C.hideAnimationDuration = 0), u.exit()),
                (u = null)));
          }),
          w("destroy", function () {
            (C.captionEl &&
              (p && d.removeChild(p), s.removeClass(m, "pswp__caption--empty")),
              g && (g.children[0].onclick = null),
              s.removeClass(d, "pswp__ui--over-close"),
              s.addClass(d, "pswp__ui--hidden"),
              A.setIdle(!1));
          }),
          C.showAnimationDuration || s.removeClass(d, "pswp__ui--hidden"),
        ...
        (A.update = function () {
          ((D = !(
            ...
            C.captionEl &&
              (C.addCaptionHTMLFn(o.currItem, m),
              M(m, "caption--empty", !o.currItem.title)),
            0)
          )),
            L || O(),
            n());
              ...
              r(t)
                ...
                : s.hasClass(t, "pswp__img") &&
                  ...
                  o.getZoomLevel() <= o.currItem.fitRatio
                    ? C.clickToCloseNonZoomable && o.close()
                    : o.toggleDesktopZoom(e.detail.releasePoint));
            else if (
              (C.tapToToggleControls &&
                (_ ? A.hideControls() : A.showControls()),
              C.tapToClose && (s.hasClass(t, "pswp__img") || r(t)))
            )
              return void o.close();
        }),
        (A.onMouseOver = function (e) {
          e = (e = e || window.event).target || e.srcElement;
          M(d, "ui--over-close", r(e));
        }),
        (A.hideControls = function () {
          (s.addClass(d, "pswp__ui--hidden"), (_ = !1));
        }),
        (A.showControls = function () {
          ((_ = !0), D || A.update(), s.removeClass(d, "pswp__ui--hidden"));
        }),
        ...
        (A.getFullscreenAPI = function () {
          ...
          return (
            ...
            e &&
              ...
              (e.exit = function () {
                return ((C.closeOnScroll = y), document[this.exitK]());
              }),
  ...
  ((e, t) => {
    ...
    return function (m, Z, t, z) {
      ...
      function N(e, t) {
        (p.extend(h, t.publicMethods), Ke.push(e));
      }
      function B(e) {
        var t = O();
      ...
      function j(e) {
        ...
        ("mousedown" === e.type && 0 < e.button) ||
          (Jt
            ? e.preventDefault()
            : (Se && "mousedown" === e.type) ||
              (Lt(e, !0) && e.preventDefault(),
              I("pointerDown"),
              pe &&
                ((t = p.arraySearch(ft, e.pointerId, "id")) < 0 &&
                  (t = ft.length),
              ...
              !u &&
                ...
                k(pt, t[1]),
                Ot(D, pt, It),
                (Et.x = Math.abs(It.x) - w.x),
                (Et.y = Math.abs(It.y) - w.y),
                (Me = Tt(D, pt)))));
      }
      function Y(e) {
        var t;
        (e.preventDefault(),
          pe &&
            -1 < (t = p.arraySearch(ft, e.pointerId, "id")) &&
          ...
          l &&
            ...
            Fe || De || u
              ...
              : M.x !== b.x * Ue
                ? (Fe = "h")
                : ((e = Math.abs(t[0].x - L.x) - Math.abs(t[0].y - L.y)),
                  Math.abs(e) >= mt && ((Fe = 0 < e ? "h" : "v"), (c = t)))));
      }
      function G(e) {
        if (s.isOldAndroid) {
        ...
        var t;
        (I("pointerUp"),
          Lt(e, !1) && e.preventDefault(),
          pe &&
            -1 < (r = p.arraySearch(ft, e.pointerId, "id")) &&
            ((t = ft.splice(r, 1)[0]),
        ...
        if (
          ...
          u &&
            n < 2 &&
            ((u = !1), 1 === n && (e = "zoomPointerUp"), I("zoomGestureEnded")),
          (c = null),
          De || Ae || v || Te)
        )
          if ((ct(), (Ie = Ie || Ut()).calculateSwipeSpeed("x"), Te))
            Rt() < f.verticalDragRange
              ? h.close()
              : ((o = w.y),
                (i = Ze),
                ut("verticalDrag", 0, 1, 300, p.easing.cubic.out, function (e) {
                  ((w.y = (h.currItem.initialPosition.y - o) * e + o),
                    T((1 - i) * e + i),
                    S());
                }),
                I("onVerticalDrag", 1));
            ...
            if (!v)
              return "swipe" !== e
                ? void jt()
                : void (!Le && y > h.currItem.fitRatio && Wt(Ie));
          }
      }
      var V,
        X,
        ...
        T = function (e) {
          ((Ze = e), (h.bg.style.opacity = e * f.bgOpacity));
        },
        Ve = function (e, t, n, o, i) {
          ((!Ye || (i && i !== h.currItem)) &&
            (o /= (i || h.currItem).fitRatio),
            (e[me] = oe + t + "px, " + n + "px" + ie + " scale(" + o + ")"));
        },
        S = function (e) {
          Oe &&
            (e &&
              (y > h.currItem.fitRatio
                ? Ye || (cn(h.currItem, !1, !0), (Ye = !0))
                : Ye && (cn(h.currItem), (Ye = !1))),
            Ve(Oe, w.x, w.y, y));
        },
        Xe = function (e) {
          e.container &&
        ...
        Qe = function (e, t) {
          ...
          (!f.loop &&
            ...
            (n = Math.round(e - M.x)),
            (t < 0 && 0 < n) || (t >= O() - 1 && n < 0)) &&
            (e = M.x + n * f.mainScrollEndFriction),
            (M.x = e),
            $e(e, Q));
        },
        Je = function (e, t) {
          var n = Et[e] - We[e];
          return Be[e] + Ne[e] + n - (t / ne) * n;
        },
        k = function (e, t) {
        ...
        rt = function (e) {
          return 0 < (e = e || h.currItem).w ? f.maxSpreadZoom : 1;
        },
        A = {},
        at = 0,
        st = function (e) {
        ...
        z = {
          ...
          setScrollOffset: function (e, t) {
            ((We.x = e), (we = We.y = t), I("updateScrollOffset", We));
          },
          ...
          init: function () {
            if (!V && !X) {
              ((h.framework = p),
                (h.template = m),
                (h.bg = p.getChildByClass(m, "pswp__bg")),
                (ge = m.className),
                (V = !0),
                (s = p.detectFeatures()),
                (he = s.raf),
                ...
                (me = s.transform),
                (ve = s.oldIE),
                (h.scrollWrap = p.getChildByClass(m, "pswp__scroll-wrap")),
                  ...
                  orientationchange: function () {
                    (clearTimeout(xe),
                      (xe = setTimeout(function () {
                        x.x !== h.scrollWrap.clientWidth && h.updateSize();
                      }, 500)));
                  },
                  scroll: K,
                  keydown: W,
              ...
              var e,
                t = s.isOldIOSPhone || s.isOldAndroid || s.isMobileOpera;
              for (
                (s.animationName && s.transform && !t) ||
                  (f.showAnimationDuration = f.hideAnimationDuration = 0),
                  e = 0;
                e < Ke.length;
                e++
              )
                h["init" + Ke[e]]();
              (Z && (h.ui = new Z(h, p)).init(),
                I("firstUpdate"),
                (g = g || f.index || 0),
                (isNaN(g) || g < 0 || g >= O()) && (g = 0),
                (h.currItem = en(g)),
                (s.isOldIOSPhone || s.isOldAndroid) && (He = !1),
                m.setAttribute("aria-hidden", "false"),
                f.modal &&
                  (He
                    ? (m.style.position = "fixed")
                    : ((m.style.position = "absolute"),
                      (m.style.top = p.getScrollY() + "px"))),
                void 0 === we &&
                  (I("initialLayout"), (we = ye = p.getScrollY())));
              var n = "pswp--open ";
              for (
                f.mainClass && (n += f.mainClass + " "),
                  f.showHideOpacity && (n += "pswp--animate_opacity "),
                  n =
                    (n =
                      (n += i ? "pswp--touch" : "pswp--notouch") +
                      (s.animationName ? " pswp--css_animation" : "")) +
                    (s.svg ? " pswp--svg" : ""),
                  p.addClass(m, n),
                  h.updateSize(),
                  J = -1,
                ...
                $e((e + J) * b.x, a[e].el.style);
              (ve || p.bind(h.scrollWrap, te, h),
                r("initialZoomInEnd", function () {
                  (h.setContent(a[0], g - 1),
                    h.setContent(a[2], g + 1),
                    (a[0].el.style.display = a[2].el.style.display = "block"),
                    f.focus && m.focus(),
                    p.bind(document, "keydown", h),
                    s.transform && p.bind(h.scrollWrap, "click", h),
                    f.mouseUsed || p.bind(document, "mousemove", nt),
          ...
          close: function () {
            V &&
              ...
              p.unbind(document, "mousemove", nt),
              s.transform && p.unbind(h.scrollWrap, "click", h),
          ...
          updateCurrZoomItem: function (e) {
            ...
            (e && I("beforeChange", 0),
              (Oe =
                ...
                ((t = a[1].el.children[0]), p.hasClass(t, "pswp__zoom-wrap"))
                  ? t.style
                  : null),
              (d = h.currItem.bounds),
              (ne = y = h.currItem.initialZoomLevel),
              (w.x = d.center.x),
              (w.y = d.center.y),
              e && I("afterChange"));
          },
          ...
          updateSize: function (e) {
            ...
            if (
              ((x.x = h.scrollWrap.clientWidth),
              (x.y = h.scrollWrap.clientHeight),
              K(),
              (b.x = x.x + Math.round(x.x * f.spacing)),
              (b.y = x.y),
              Qe(b.x * Ue),
              I("beforeResize"),
              void 0 !== J)
              ...
              for (var n, o, i, r = 0; r < 3; r++)
                ((n = a[r]),
                  $e((r + J) * b.x, n.el.style),
                  (i = g + r - 1),
                  f.loop && 2 < O() && (i = B(i)),
                  (o = en(i)) && (ae || o.needsUpdate || !o.bounds)
                    ? (h.cleanSlide(o),
                      h.setContent(n, i),
                      1 === r && ((h.currItem = o), h.updateCurrZoomItem(!0)),
                      (o.needsUpdate = !1))
                    : -1 === n.index && 0 <= i && h.setContent(n, i),
                  o && o.container && (sn(o, x), cn(o), Xe(o)));
              ae = !1;
            }
            ((ne = y = h.currItem.initialZoomLevel),
              (d = h.currItem.bounds) &&
          ...
          zoomTo: function (t, e, n, o, i) {
            e &&
              ((ne = y),
              (Et.x = Math.abs(e.x) - w.x),
              (Et.y = Math.abs(e.y) - w.y),
              k(Be, w));
            function r(e) {
              (1 === e
                ? ((y = t), (w.x = a.x), (w.y = a.y))
        ...
        At = function () {
          return !("fit" === f.scaleMode && y === h.currItem.initialZoomLevel);
        },
        Dt = function (e, t) {
          return (
            !(!e || e === document) &&
        ...
        Lt = function (e, t) {
          return (
            (_t.prevent = !Dt(e.target, f.isClickableElement)),
            I("preventDragEvent", e, t, _t),
            _t.prevent
          );
        },
        Mt = function (e, t) {
        ...
        Ft = function (e, t, n) {
          var o;
          50 < e - Ee &&
            (((o = 2 < yt.length ? yt.shift() : {}).x = t),
            (o.y = n),
            yt.push(o),
            (Ee = e));
        },
        Rt = function () {
          var e = w.y - h.currItem.initialPosition.y;
            ...
            pe
              ? ((qe = 0),
                ft.forEach(function (e) {
                  (0 === qe ? (zt[0] = e) : 1 === qe && (zt[1] = e), qe++);
                }))
              : -1 < e.type.indexOf("touch")
                ? e.touches &&
                  0 < e.touches.length &&
                  ((zt[0] = Mt(e.touches[0], Pt)), 1 < e.touches.length) &&
                  (zt[1] = Mt(e.touches[1], Zt))
                : ((Pt.x = e.pageX),
                  (Pt.y = e.pageY),
                  (Pt.id = ""),
                  (zt[0] = Pt)),
        ...
        Nt = function (e, t) {
          var n,
            ...
            a = M.x + t.x,
            s = M.x - gt.x,
            l = r > d.min[e] || r < d.max[e] ? f.panEndFriction : 1,
            r = w[e] + t[e] * l;
          return (!f.allowPanToNext && y !== h.currItem.initialZoomLevel) ||
            (Oe
              ? "h" !== Fe ||
                "x" !== e ||
                Ae ||
                (0 < t[e]
                  ...
                  : (r < d.max[e] &&
                      ...
                      (n = Be[e] - d.max[e])),
                    (n <= 0 || 0 < s) && 1 < O()
                      ? ((i = a), 0 < s && a < gt.x && (i = gt.x))
                      : d.min.x !== d.max.x && (o = r)))
              : (i = a),
            "x" !== e)
            ? void (v || Le || (y > h.currItem.fitRatio && (w[e] += t[e] * l)))
            : (void 0 !== i && (Qe(i, !0), (Le = i !== gt.x)),
              d.min.x !== d.max.x &&
                (void 0 !== o ? (w.x = o) : Le || (w.x += t.x * l)),
              void 0 !== i);
        },
        Bt = function () {
          var e, t, n, o, i, r;
          c &&
            ...
            u && 1 < e
              ? ((L.x = D.x),
                ...
                (!_.x && !_.y && Ct(c[1], pt)) ||
                  (k(pt, c[1]),
                  Ae || ((Ae = !0), I("zoomGestureStarted")),
                  (e = Tt(D, pt)),
                  (t = Kt(e)) >
                    h.currItem.initialZoomLevel +
                      h.currItem.initialZoomLevel / 15 && (ze = !0),
                  (n = 1),
                  (o = it()),
                  (i = rt()),
                  t < o
                    ? f.pinchToClose && !ze && ne <= h.currItem.initialZoomLevel
                      ? (T((r = 1 - (o - t) / (o / 1.2))),
                        I("onPinchClose", r),
                        (Pe = !0))
                      : (t = o - (n = 1 < (n = (o - t) / o) ? 1 : n) * (o / 3))
                    : i < t &&
                      (t = i + (n = 1 < (n = (t - i) / (6 * o)) ? 1 : n) * o),
                  n < 0 && (n = 0),
                  Ot(D, pt, xt),
                  (Ne.x += xt.x - It.x),
                  (Ne.y += xt.y - It.y),
              ...
              : Fe &&
                (Re &&
                  ((Re = !1),
                  Math.abs(_.x) >= mt && (_.x -= c[0].x - ht.x),
                  Math.abs(_.y) >= mt) &&
                  (_.y -= c[0].y - ht.y),
                (L.x = D.x),
                (L.y = D.y),
                (0 === _.x && 0 === _.y) ||
                  ("v" === Fe && f.closeOnVerticalDrag && !At()
                    ? ((Ne.y += _.y),
                      (w.y += _.y),
                      (r = Rt()),
                      (Te = !0),
          ...
          var t,
            ...
            o = {
              ...
              calculateSwipeSpeed: function (e) {
                ((n = (
                  1 < yt.length
                    ? ((t = C() - Ee + 50), yt[yt.length - 2])
                    : ((t = C() - be), ht)
                )[e]),
                  (o.lastFlickOffset[e] = L[e] - n),
              ...
              calculateOverBoundsAnimOffset: function (t, e) {
                o.backAnimStarted[t] ||
                  (w[t] > d.min[t]
                    ...
                    : w[t] < d.max[t] && (o.backAnimDestination[t] = d.max[t]),
              ...
              panAnimLoop: function () {
                A.zoomPan &&
                  ((A.zoomPan.raf = he(o.panAnimLoop)),
                  (o.now = C()),
        ...
        Ht = function (e, t) {
          ...
          (v || (wt = g),
            "swipe" === e &&
              ...
              dt < e && (r || 20 < t.lastFlickOffset.x)
                ? (o = -1)
                : e < -dt && (r || t.lastFlickOffset.x < -20) && (o = 1)),
            o &&
              ((g += o) < 0
                ? ((g = f.loop ? O() - 1 : 0), (i = !0))
                : g >= O() && ((g = f.loop ? 0 : O() - 1), (i = !0)),
              (i && !f.loop) || ((E += o), (Ue -= o), (n = !0))));
          var e = b.x * Ue,
            r = Math.abs(e - M.x),
            a =
              n || e > M.x == 0 < t.lastFlickSpeed.x
                ? ((a =
          ...
          return (
            wt === g && (n = !1),
            (v = !0),
            I("mainScrollAnimStart"),
            ut("mainScroll", M.x, e, a, p.easing.cubic.out, Qe, function () {
              (ct(),
                (v = !1),
                (wt = -1),
                (!n && wt === g) || h.updateCurrItem(),
                I("mainScrollAnimComplete"));
            }),
          ...
          return (
            Pe && !Ce && !ze && y < t
              ...
              : (Pe &&
                ...
                h.zoomTo(e, 0, 200, p.easing.cubic.out, o)),
            !0
          );
        };
      N("Gestures", {
      ...
      function Gt(e, t) {
        return (
          ...
          (e.container.innerHTML = f.errorMsg.replace("%url%", e.src)),
          1)
        );
      }
      function Vt() {
      ...
      var Xt,
        ...
        tn = function (r, e, a, t) {
          ...
          (Xt && clearTimeout(Xt),
            ...
            r.initialLayout
              ...
              : (l = f.getThumbBoundsFn && f.getThumbBoundsFn(g)));
          var l,
            c,
            u,
            d = a ? f.hideAnimationDuration : f.showAnimationDuration;
          d && l && void 0 !== l.x
            ? ((c = $),
              (u =
                !h.currItem.src || h.currItem.loadError || f.showHideOpacity),
              r.miniImg &&
              ...
              a ||
                ...
                (w.x = l.x),
                (w.y = l.y - ye),
                (h[u ? "template" : "bg"].style.opacity = 0.001),
                S()),
              lt("initialZoom"),
                  ...
                  (I("initialZoom" + (a ? "Out" : "In")),
                    a
                      ? ((t = l.w / r.w),
                        ...
                        (e = function (e) {
                          (1 === e
                            ? ((y = t), (w.x = l.x), (w.y = l.y - we))
                            : ((y = (t - o) * e + o),
                              (w.x = (l.x - n.x) * e + n.x),
                              (w.y = (l.y - we - n.y) * e + n.y)),
                            S(),
                            u ? (m.style.opacity = 1 - e) : T(i - e * i));
                        }),
                        c
                          ? ut("initialZoom", 0, 1, d, p.easing.cubic.out, e, s)
                          : (e(1), (Xt = setTimeout(s, d + 20))))
                      : ((y = r.initialZoomLevel),
                        k(w, r.initialPosition),
                        S(),
                        T(1),
                        u ? (m.style.opacity = 1) : T(1),
        ...
        an = function (e, t, n) {
          var o = e.bounds;
          ((o.center.x = Math.round((F.x - t) / 2)),
            (o.center.y = Math.round((F.y - n) / 2) + e.vGap.top),
            (o.max.x = t > F.x ? Math.round(F.x - t) : o.center.x),
            (o.max.y = n > F.y ? Math.round(F.y - n) + e.vGap.top : o.center.y),
            (o.min.x = t > F.x ? 0 : o.center.x),
            (o.min.y = n > F.y ? e.vGap.top : o.center.y));
        },
        sn = function (e, t, n) {
          var o, i;
          return e.src && !e.loadError
            ? ((o = !n) &&
                ...
                I("parseVerticalMargin", e)),
              (F.x = t.x),
              (F.y = t.y - e.vGap.top - e.vGap.bottom),
              o &&
                ((t = F.x / e.w),
                (i = F.y / e.h),
                (e.fitRatio = t < i ? t : i),
            ...
            (p.extend(f, on, !0),
              ...
              r("beforeChange", function (e) {
                for (
                  ...
                  h.lazyLoadItem(g + r);
                for (r = 1; r <= (n ? o : i); r++) h.lazyLoadItem(g - r);
              }),
              r("initialLayout", function () {
                h.currItem.initialLayout =
                  f.getThumbBoundsFn && f.getThumbBoundsFn(g);
              }),
            ...
            e
              ? (I("gettingData", n, e),
                ...
                !e.src || e.loadError || e.loaded
                  ? e.src &&
                    !e.loadError &&
                    (((o = p.createEl("pswp__img", "img")).style.opacity = 1),
                    (o.src = e.src),
                    cn(e, o),
                    ln(n, e, i, o, !0))
                  : ((e.loadComplete = function (e) {
                    ...
                    h.allowProgressiveImg() &&
                      (!Qt && s.transform
                        ...
                        : ln(n, e, i, e.img, !0, !0))),
                Qt || n !== g ? Xe(e) : ((Oe = i.style), tn(e, o || e.img)),
                (t.el.innerHTML = ""),
                t.el.appendChild(i))
              : (t.el.innerHTML = "");
          },
          ...
          publicMethods: {
            ...
            setupDesktopZoom: function (e) {
              ...
              (r("bindEvents", function () {
                p.bind(m, t, h.handleMouseWheel);
              }),
                r("unbindEvents", function () {
                  R && p.unbind(m, t, h.handleMouseWheel);
                }),
                (h.mouseZoomedIn = !1));
              function n() {
                (h.mouseZoomedIn &&
                  (p.removeClass(m, "pswp--zoomed-in"), (h.mouseZoomedIn = !1)),
                  y < 1
                    ? p.addClass(m, "pswp--zoom-allowed")
                    : p.removeClass(m, "pswp--zoom-allowed"),
                  i());
              }
              var o,
                i = function () {
              ...
              (r("resize", n),
                ...
                r("pointerDown", function () {
                  h.mouseZoomedIn &&
                    ((o = !0), p.addClass(m, "pswp--dragging"));
                }),
                r("pointerUp", i),
                e || n());
            },
            handleMouseWheel: function (e) {
              if (y <= h.currItem.fitRatio)
                return (
                  f.modal &&
                    (!f.closeOnScroll || at || l
                      ? e.preventDefault()
                      : me && 2 < Math.abs(e.deltaY) && (($ = !0), h.close())),
                  !0
                );
              if ((e.stopPropagation(), (R.x = 0), "deltaX" in e))
                1 === e.deltaMode
                  ? ((R.x = 18 * e.deltaX), (R.y = 18 * e.deltaY))
                  : ((R.x = e.deltaX), (R.y = e.deltaY));
              else if ("wheelDelta" in e)
                (e.wheelDeltaX && (R.x = -0.16 * e.wheelDeltaX),
                  (R.y = e.wheelDeltaY
                    ? -0.16 * e.wheelDeltaY
                    : -0.16 * e.wheelDelta));
              else {
            ...
            toggleDesktopZoom: function (e) {
              ...
              var t = f.getDoubleTapZoom(!0, h.currItem),
                n = y === t;
              ((h.mouseZoomedIn = !n),
                h.zoomTo(n ? h.currItem.initialZoomLevel : t, e, 333),
                p[(n ? "remove" : "add") + "Class"](m, "pswp--zoomed-in"));
            },
          },
        }));
      function pn() {
      ...
      function hn() {
        ...
        if (!(e.length < 5)) {
          ...
          if (f.galleryPIDs) {
            for (var i = t.pid, r = (t.pid = 0); r < $t.length; r++)
              if ($t[r].pid === i) {
                t.pid = r;
                break;
              }
      ...
      var fn,
        ...
        kn = function () {
          ...
          (yn && clearTimeout(yn),
            at || l
              ? (yn = setTimeout(kn, 500))
              : (vn ? clearTimeout(gn) : (vn = !0),
                (t = g + 1),
                (e = en(g)).hasOwnProperty("pid") && (t = e.pid),
                (e = n + "&gid=" + f.galleryUID + "&pid=" + t),
                bn || (-1 === P.hash.indexOf(e) && (In = !0)),
                (t = P.href.split("#")[0] + "#" + e),
                Cn
            ...
            (p.extend(f, Tn, !0),
              f.history &&
                ...
                -1 < (t = n.indexOf("pid=")) &&
                  ...
                  (n = n.slice(0, -1)),
                setTimeout(function () {
                  V && p.bind(window, "hashchange", h.onHashChange);
                }, 40)));
          },
          onHashChange: function () {
            return Sn() === n
              ? ((En = !0), void h.close())
              : void (vn || ((wn = !0), h.goTo(hn().pid), (wn = !1)));
          },
          updateURL: function () {
            (pn(), wn || (bn ? (fn = setTimeout(kn, 800)) : kn()));
          },
        },
      }),
        p.extend(h, z));
  ...
  (() => {
    var e = document.querySelector(".vb-burger");
    e &&
  ...
  reframe(
    document.querySelectorAll(
      [
        '.vb-content iframe[src*="youtube.com"]',
        '.vb-content iframe[src*="youtube-nocookie.com"]',
        '.vb-content iframe[src*="player.vimeo.com"]',
        '.vb-content iframe[src*="kickstarter.com"][src*="video.html"]',
        ".vb-content object",
        ".vb-content embed",
      ].join(","),
    ),
