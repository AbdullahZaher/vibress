    ...
    <header id="vb-head" className="vb-head vb-outer">
      <div className="vb-head-inner vb-inner">
        <div className="vb-head-brand">
          ...
          <button type="button" className="vb-search vb-icon-btn" aria-label={t('search.thisSite')} data-vb-search>
          ...
          <button type="button" className="vb-burger" aria-label={t('menu.toggle')}></button>
        </div>

        <nav className="vb-head-menu">
          <ul className="nav">
            <li className="nav-home"><a href="/">{t('nav.home')}</a></li>
        ...
        <div className="vb-head-actions">
          <div className="vb-head-members">
            <a className="vb-head-link" href="#/portal/signin">{t('nav.signin')}</a>
            <a className="vb-head-btn vb-btn vb-primary-btn" href="#/portal/signup">{t('nav.subscribe')}</a>
          </div>
        </div>
      </div>
    </header>
