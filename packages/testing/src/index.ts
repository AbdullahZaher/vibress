...
export async function truncateAllTestTables(pool: PoolQueryClient): Promise<void> {
  await pool.query(`
...
export async function withMockEnv<T>(env: Record<string, string>, fn: () => Promise<T>): Promise<T> {
