...
export function FloatingFormatToolbarPlugin({
  ...
  const [openDropdown, setOpenDropdown] = useState<"turnInto" | "color" | null>(
    null,
  );
  ...
  return createPortal(
    ...
    >
      ...
      <button
        ...
        onClick={() => {
          alert(
            'Select "Ask AI" from slash command or press Space on a new line.',
          );
        }}
        style={{
          display: "flex",
      ...
      <div style={{ position: "relative" }}>
        <button
          type="button"
          onClick={() =>
            setOpenDropdown(openDropdown === "turnInto" ? null : "turnInto")
          }
          style={{
            display: "flex",
            alignItems: "center",
