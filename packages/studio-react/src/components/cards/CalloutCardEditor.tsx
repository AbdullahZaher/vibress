...
const BG_COLORS: Record<string, string> = {
  ...
  green:
    "bg-emerald-500/10 dark:bg-emerald-500/15 text-emerald-950 dark:text-emerald-200 border-emerald-500/25 backdrop-blur-sm",
  yellow:
    "bg-amber-500/10 dark:bg-amber-500/15 text-amber-950 dark:text-amber-200 border-amber-500/25 backdrop-blur-sm",
  ...
  purple:
    "bg-purple-500/10 dark:bg-purple-500/15 text-purple-950 dark:text-purple-200 border-purple-500/25 backdrop-blur-sm",
};
      ...
      <div className="flex-shrink-0 text-2xl leading-none flex items-start pt-0.5">
        <input
          ...
          onChange={(e) => {
            ...
            const newEmoji =
              (val.trim() ? Array.from(val.trim())[0] : "💡") || "💡";
