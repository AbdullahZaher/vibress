    ...
    root: {
      children: [
          ...
          children: [
            {
              type: "text",
              version: 1,
              text: "This page contains all the different cards and elements supported by the Vibress Studio editor.",
            },
          ],
          direction: "ltr",
          format: "",
...

        {
          type: "heading",
          tag: "h2",
          children: [{ type: "text", version: 1, text: "1. Media Cards" }],
          direction: "ltr",
          format: "",
          indent: 0,
          version: 1,
        ...
        },
        {
          ...
          cardData: {
            images: [
              {
                src: "https://images.unsplash.com/photo-1682687982501-1e58b8147144?q=80&w=2940",
                alt: "Gallery image 1",
              },
              {
                src: "https://images.unsplash.com/photo-1682687220199-d0124f48f95b?q=80&w=2940",
                alt: "Gallery image 2",
              },
              {
                src: "https://images.unsplash.com/photo-1682687982502-1529b3b33f69?q=80&w=2940",
                alt: "Gallery image 3",
              },
            ],
          },
...

        {
          type: "heading",
          tag: "h2",
          children: [{ type: "text", version: 1, text: "2. Content Cards" }],
          direction: "ltr",
          format: "",
          indent: 0,
          version: 1,
        },
        {
          ...
          cardData: {
            ...
            description:
              "Build your audience with Vibress. The modern publishing platform.",
            iconUrl: "https://vibress.com/favicon.ico",
            thumbnailUrl:
              "https://images.unsplash.com/photo-1557683316-973673baf926?q=80&w=2929",
          },
          version: 1,
        },
        {
        ...
        },
        {
          ...
          cardData: {
            ...
            content:
              "Vibress is a modern, open-source publishing platform built for creators, journalists, and businesses.",
          },
          version: 1,
        },
        {
...

        {
          type: "heading",
          tag: "h2",
          children: [{ type: "text", version: 1, text: "3. Structure Cards" }],
          direction: "ltr",
          format: "",
          indent: 0,
          version: 1,
