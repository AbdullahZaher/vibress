...
export const webhookDeliveries = pgTable('webhook_deliveries', {
  ...
  return {
    ...
    uniqueEndpointEventIdx: uniqueIndex('webhook_deliveries_endpoint_event_idx').on(table.endpointId, table.eventId),
  };
});
...
export const pluginSettings = pgTable('plugin_settings', {
  ...
  return {
    uniquePluginKeyIdx: uniqueIndex('plugin_settings_plugin_key_idx').on(table.pluginId, table.key),
  };
});
