...
export const storageConfigurations = pgTable('storage_configurations', {
  ...
  return {
    providerTypeIdx: index('storage_configurations_provider_type_idx').on(table.providerType),
    isActiveIdx: index('storage_configurations_is_active_idx').on(table.isActive),
  };
});
...
export const uploadSessions = pgTable('upload_sessions', {
  ...
  storageConfigurationId: text('storage_configuration_id').references(() => storageConfigurations.id, { onDelete: 'set null' }),
  ...
  return {
    ...
    storageKeyIdx: index('upload_sessions_storage_key_idx').on(table.storageKey),
...
export type NewStorageConfigurationRow = typeof storageConfigurations.$inferInsert;
