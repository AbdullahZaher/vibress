...
export const commentLikes = pgTable(
  ...
  (table) => {
    return {
      uniqueLikeIdx: uniqueIndex("comment_likes_member_comment_idx").on(
        table.memberId,
        table.commentId,
      ),
...
export const recommendations = pgTable(
  ...
  (table) => {
    return {
      statusIdx: index("recommendations_status_idx").on(
        table.status,
        table.sortOrder,
      ),
    };
...
export const recommendationEvents = pgTable(
  ...
  (table) => {
    return {
      recommendationIdx: index("recommendation_events_rec_idx").on(
...
export type NewRecommendationEventRow =
  typeof recommendationEvents.$inferInsert;
