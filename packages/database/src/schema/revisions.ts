...
export const revisions = pgTable('revisions', {
  ...
  return {
    resourceRevisionIdx: uniqueIndex('revisions_resource_revision_idx').on(table.resourceType, table.resourceId, table.revisionNumber),
    resourceIdIdx: index('revisions_resource_id_idx').on(table.resourceType, table.resourceId),
  };
});
