...
export const automationVersions = pgTable(
  ...
  (table) => {
    return {
      uniqueVersionIdx: uniqueIndex("automation_versions_unique_idx").on(
        table.automationId,
        table.version,
      ),
    };
...
export const automationRuns = pgTable(
  ...
  (table) => {
    return {
      ...
      uniqueRunKeyIdx: uniqueIndex("automation_runs_unique_run_key_idx").on(
        table.automationId,
        table.runKey,
      ),
    };
...
export const automationRunSteps = pgTable(
  ...
  (table) => {
    return {
      uniqueRunStepIdx: uniqueIndex("automation_run_steps_unique_idx").on(
        table.runId,
        table.stepIndex,
      ),
