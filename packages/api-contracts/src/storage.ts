...
export type InitiateDirectUploadInput = z.infer<
  typeof InitiateDirectUploadInputSchema
>;

export const CompleteDirectUploadInputSchema = z.object({
  uploadSessionId: z.string().min(1),
});
export type CompleteDirectUploadInput = z.infer<
  typeof CompleteDirectUploadInputSchema
>;
...
export type InitiateMultipartUploadInput = z.infer<
  typeof InitiateMultipartUploadInputSchema
>;
...
export type SignMultipartPartInput = z.infer<
  typeof SignMultipartPartInputSchema
>;
