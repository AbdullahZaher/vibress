...
export function resolveS3ConfigWithPreset(config) {
    ...
    const forcePathStyle = config.forcePathStyle !== undefined ? config.forcePathStyle : preset.defaultForcePathStyle;
    return {
        ...config,
        region,
        endpoint,
