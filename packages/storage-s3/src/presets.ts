...
export const S3_PRESETS: Record<S3ProviderType, S3ProviderPreset> = {
  ...
  "cloudflare-r2": {
    ...
    description:
      "S3-compatible object storage with zero egress fees by Cloudflare",
  },
  "digitalocean-spaces": {
  ...
  "backblaze-b2": {
    ...
    defaultForcePathStyle: false,
    description:
      "High-performance, low-cost S3-compatible storage by Backblaze",
  },
  hetzner: {
...
export function resolveS3ConfigWithPreset(
